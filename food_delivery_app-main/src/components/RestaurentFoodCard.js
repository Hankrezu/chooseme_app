...
const RestaurentFoodCard = ({id,restaurentId, name, description, price, image, navigate}) => {
  ...
  return (
    <View style={styles.container}>
      <TouchableOpacity onPress={() => navigate(id)} activeOpacity={0.8}>
        <Image
          style={styles.image}
          source={{
...
export default RestaurentFoodCard;
